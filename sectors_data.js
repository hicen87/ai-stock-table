window.SECTOR_TABLE_DATA = {
  ...
  dataNote: "估值：FactSet Earnings Insight 2026-07-10（标普FPE 20.4→20.5，高于5年均值19.9/10年均值19.0；可选消费25.9与工业25.5最高、能源12.9与金融15.4最低——周环比微动无翻转）+ SPDR板块ETF FY1 PE（XLC 14.3/XLU 19.0为7/2口径，XLV 17.7/XLP 19.6为3/31 factsheet口径，本周未获新读数、保留原值；FY1系统性低于FactSet NTM口径，两套锚不可横比）+ MacroMicro（科技≈21.7）· 基本面：FactSet 7-10（Q2 EPS预期+23.6%已开季：4%公司已报、89% EPS beat；Q3预期+26.6%/Q4+24.3%/CY26+24.2%/CY27+17.4%；7板块dollar-EPS上修由能源/科技/材料领跑、下修由医疗领跑——医疗CY26修正仍为负，入池条件未触发；能源CY26增速预期7.7%→13.4%、科技25.2%→30.7%自3/31大幅上修）· 条款检查：科技溢价未到+30%、工业25.5>22、10Y利率4.56%（近两月高位但非50bp急升）——本周无条款触发",
