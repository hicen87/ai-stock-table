window.SECTOR_TABLE_DATA = {
  ...
  scoreAnchors: [
    ...
    "估值锚：FPE vs 标普500（20.4，6月底FactSet口径）+ 自身5年中枢分位；能源/材料等周期板块禁用FPE排序，改用盈利分位——能源2026E EPS +122%即典型周期高基数，低PE≠便宜",
  ...
  rows: [
    ...
    { rank: 10, segment: "可选消费", vtype: "周期", scarcity: 3, pool: 6, expand: 3, pricing: 4, status: "❌", marginal: "🟡", leaders: "XLY · AMZN/TSLA", fpe: "26.1（FactSet 7/2，11板块最高）", anchor2: "板块FPE被AMZN/TSLA双巨头扭曲；等权口径下普通零售无定价权", priced: "🔴", verdict: "扩产难度3出局；AMZN敞口走云平台行", tier: "out", sizeBand: "0",
